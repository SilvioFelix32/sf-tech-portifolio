    ...
    () => [
      {
        ...
        techGroups: [
          ...
          { label: t("exp_1_group_academic_languages_label"), items: parseList(t("exp_1_group_academic_languages_items")) },
          { label: t("exp_1_group_frontend_label"), items: parseList(t("exp_1_group_frontend_items")) },
          { label: t("exp_1_group_backend_label"), items: parseList(t("exp_1_group_backend_items")) },
          { label: t("exp_1_group_api_label"), items: parseList(t("exp_1_group_api_items")) },
          { label: t("exp_1_group_architecture_label"), items: parseList(t("exp_1_group_architecture_items")) },
          ...
          { label: t("exp_1_group_methodologies_label"), items: parseList(t("exp_1_group_methodologies_items")) },
          { label: t("exp_1_group_ai_label"), items: parseList(t("exp_1_group_ai_items")) },
        ],
        current: true,
      },
      {
